        ...
        <Modal.Header closeButton>
          <Modal.Title>
            <h1 className="display-4 modal-title">
              Privacy Policy: 
              <span className="branded"> OLLA AI Social Media Responder</span>
            </h1>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <div className="container-fluid page privacy-policy">
          <div className="row">
            <div className="col-12">
              ...
              <ul>
                ...
                <li>
                  <p>
                    <strong>Application</strong> refers to OLLA AI Social
                    Media Responder , the software program provided by the
                    Company.
                  </p>
                </li>
                <li>
                  <p>
                    ...
                    OLLA AI PTE LTD, 143 Cecil Street, Singapore, Singapore,
                    069542.
                  </p>
                </li>
                <li>
              ...
              <ul>
                <li>By email: tta@cloude8.com</li>
              </ul>
            </div>
          </div>
        </div>
