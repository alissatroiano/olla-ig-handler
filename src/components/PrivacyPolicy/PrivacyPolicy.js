      ...
      <div className="row">
        <div className="col-12 text-center">
          <h1 className="display-1">
            Privacy Policy for OLLA AI Social Media Responder{" "}
          </h1>
        </div>
        <div className="col-12">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to OLLA AI Social Media
                Responder , the software program provided by the Company.
              </p>
            </li>
            <li>
              <p>
                <strong>Company</strong> (referred to as either "the Company",
                "We", "Us" or "Our" in this Agreement) refers to OLLA AI PTE
                LTD, 143 Cecil Street, Singapore, Singapore, 069542.
              </p>
            </li>
            <li>
              <p>
